...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_idfk_idfk_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_idfk_thorns_easy_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_idfk_thorns_hard_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_idfk_thornsdialogue_txt extends null { }
...
@:keep @:file("assets/preload/data/idfk/idfk.json") @:noCompletion #if display private #end class __ASSET__assets_data_idfk_idfk_json extends haxe.io.Bytes {}
@:keep @:file("assets/preload/data/idfk/thorns-easy.json") @:noCompletion #if display private #end class __ASSET__assets_data_idfk_thorns_easy_json extends haxe.io.Bytes {}
@:keep @:file("assets/preload/data/idfk/thorns-hard.json") @:noCompletion #if display private #end class __ASSET__assets_data_idfk_thorns_hard_json extends haxe.io.Bytes {}
@:keep @:file("assets/preload/data/idfk/thornsDialogue.txt") @:noCompletion #if display private #end class __ASSET__assets_data_idfk_thornsdialogue_txt extends haxe.io.Bytes {}
