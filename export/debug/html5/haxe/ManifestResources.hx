...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_five_nights_at_freddys_dialogue_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_five_nights_at_freddys_five_nights_at_freddys_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_five_nights_at_freddys_roses_easy_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_five_nights_at_freddys_roses_hard_json extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_its_been_so_long_its_been_so_long_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_its_been_so_long_senpai_easy_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_its_been_so_long_senpai_hard_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_its_been_so_long_senpaidialogue_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_just_gold_just_gold_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_just_gold_thorns_easy_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_just_gold_thorns_hard_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_just_gold_thornsdialogue_txt extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_fnaf1_inst_mp3 extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_fnaf1_voices_mp3 extends null { }
...
@:keep @:file("assets/preload/data/five nights at freddys/dialogue.txt") @:noCompletion #if display private #end class __ASSET__assets_data_five_nights_at_freddys_dialogue_txt extends haxe.io.Bytes {}
@:keep @:file("assets/preload/data/five nights at freddys/five nights at freddys.json") @:noCompletion #if display private #end class __ASSET__assets_data_five_nights_at_freddys_five_nights_at_freddys_json extends haxe.io.Bytes {}
@:keep @:file("assets/preload/data/five nights at freddys/roses-easy.json") @:noCompletion #if display private #end class __ASSET__assets_data_five_nights_at_freddys_roses_easy_json extends haxe.io.Bytes {}
@:keep @:file("assets/preload/data/five nights at freddys/roses-hard.json") @:noCompletion #if display private #end class __ASSET__assets_data_five_nights_at_freddys_roses_hard_json extends haxe.io.Bytes {}
...
@:keep @:file("assets/preload/data/its been so long/its been so long.json") @:noCompletion #if display private #end class __ASSET__assets_data_its_been_so_long_its_been_so_long_json extends haxe.io.Bytes {}
@:keep @:file("assets/preload/data/its been so long/senpai-easy.json") @:noCompletion #if display private #end class __ASSET__assets_data_its_been_so_long_senpai_easy_json extends haxe.io.Bytes {}
@:keep @:file("assets/preload/data/its been so long/senpai-hard.json") @:noCompletion #if display private #end class __ASSET__assets_data_its_been_so_long_senpai_hard_json extends haxe.io.Bytes {}
@:keep @:file("assets/preload/data/its been so long/senpaiDialogue.txt") @:noCompletion #if display private #end class __ASSET__assets_data_its_been_so_long_senpaidialogue_txt extends haxe.io.Bytes {}
@:keep @:file("assets/preload/data/just gold/just gold.json") @:noCompletion #if display private #end class __ASSET__assets_data_just_gold_just_gold_json extends haxe.io.Bytes {}
@:keep @:file("assets/preload/data/just gold/thorns-easy.json") @:noCompletion #if display private #end class __ASSET__assets_data_just_gold_thorns_easy_json extends haxe.io.Bytes {}
@:keep @:file("assets/preload/data/just gold/thorns-hard.json") @:noCompletion #if display private #end class __ASSET__assets_data_just_gold_thorns_hard_json extends haxe.io.Bytes {}
@:keep @:file("assets/preload/data/just gold/thornsDialogue.txt") @:noCompletion #if display private #end class __ASSET__assets_data_just_gold_thornsdialogue_txt extends haxe.io.Bytes {}
...
@:keep @:file("assets/songs/fnaf1/Inst.mp3") @:noCompletion #if display private #end class __ASSET__assets_songs_fnaf1_inst_mp3 extends haxe.io.Bytes {}
@:keep @:file("assets/songs/fnaf1/Voices.mp3") @:noCompletion #if display private #end class __ASSET__assets_songs_fnaf1_voices_mp3 extends haxe.io.Bytes {}
