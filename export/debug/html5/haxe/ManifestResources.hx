...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_five_nights_at_freddys_rosesdialogue_txt extends null { }
...
@:keep @:file("assets/preload/data/five nights at freddys/rosesDialogue.txt") @:noCompletion #if display private #end class __ASSET__assets_data_five_nights_at_freddys_rosesdialogue_txt extends haxe.io.Bytes {}
