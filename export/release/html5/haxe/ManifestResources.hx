...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_fnaf2_fresh_easy_json extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_fnaf2_fresh_hard_json extends null { }
...
@:keep @:file("assets/preload/data/fnaf2/fresh-easy.json") @:noCompletion #if display private #end class __ASSET__assets_data_fnaf2_fresh_easy_json extends haxe.io.Bytes {}
@:keep @:file("assets/preload/data/fnaf2/fresh-hard.json") @:noCompletion #if display private #end class __ASSET__assets_data_fnaf2_fresh_hard_json extends haxe.io.Bytes {}
